...
import {
  MapPin, ClipboardCheck, History, FileText,
  BarChart2, CheckCircle2, Clock, XCircle,
  User, Mail, Shield, PenLine, Upload, Plus,
} from "lucide-react";
...
const DashboardOverview = ({ setActiveSection }) => {
  const [adminData, setAdminData] = useState({
    approver_name: "", approver_email: "", approver_designation: "", approver_signature: null,
  });
    ...
    <div>
      ...
      <div className="flex items-center justify-between px-8 py-6 bg-slate-50 rounded-xl">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Manage your system at a glance.</p>
        </div>

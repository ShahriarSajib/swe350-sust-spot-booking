...
const ReserveSpotPanel = ({ onClose }) => {
  ...
  const handleReserve = async () => {
    console.log("🔥 Reserve clicked"); // ADD THIS
    ...
    try {
      ...
      setToast({
        msg: `${selectedSpotName} reserved successfully!`,
        type: "success",
      });
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 13, color: "#7f1d1d" }}>
                        {conflictInfo.msg ||
                          "An event is already booked on this date."}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {dateReady && (
                ...
                >
                  ...
                  <span
                    style={{ fontWeight: 700, fontSize: 13, color: "#15803d" }}
                  >
                    {bookingType === "single"

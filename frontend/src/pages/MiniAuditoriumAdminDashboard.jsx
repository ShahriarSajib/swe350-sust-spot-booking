      ...
      <div className="grid grid-cols-3 gap-8">
        ...
        <div className="col-span-2 bg-white rounded-3xl border border-gray-100 p-6 shadow-sm">
          ...
          <div className="space-y-2">
            <ActivityRow name="John Doe" action="requested Mini Auditorium" event="Tech Fest 2026" date="24th May, 2026" />
            <ActivityRow name="John Doe" action="requested Mini Auditorium" event="Tech Fest 2026" date="24th May, 2026" />
            <ActivityRow name="John Doe" action="requested Mini Auditorium" event="Tech Fest 2026" date="24th May, 2026" />
          </div>
        </div>
...
import mainImage_display from "../assets/mini_auditorium.png";
...
const allHistoryData = [
  { id: "REQ-001", title: "Annual Debate Competition", spotName: "Mini Auditorium", organizer: "Debating Society", date: "2026-06-15", type: "Single Day", status: "Approved" },
  { id: "REQ-002", title: "Sust Inter-Dept Football", spotName: "Mini Auditorium", organizer: "Physical Dept", startDate: "2026-06-20", endDate: "2026-06-22", type: "Date Range", status: "Rejected" },
  ...
  { id: "REQ-004", title: "IEEE Workshop", spotName: "Mini Auditorium", organizer: "IEEE Student Branch", date: "2026-06-05", type: "Single Day", status: "Approved" },
  { id: "REQ-005", title: "Cultural Night", spotName: "Mini Auditorium", organizer: "Sust Himesh", date: "2026-06-12", type: "Single Day", status: "Approved" },
];

import { Camera, Lock, User, X } from "lucide-react";
      ...
      <div className="bg-white rounded-xl shadow p-6 space-y-6 border border-gray-100">
        ...
        <div className="text-sm space-y-2 bg-gray-50 p-4 rounded-xl">
          <p className="text-gray-600">
            <b className="text-gray-800">Department:</b> {profile.department}
          </p>
          <p className="text-gray-600">
            <b className="text-gray-800">Email:</b> {profile.email}
          </p>
          <p className="text-gray-600">
            <b className="text-gray-800">Contact:</b> {profile.contact}
          </p>
      ...
      {showEdit && (
        <div className="absolute top-0 left-full ml-4 w-[360px] bg-white shadow-2xl rounded-2xl p-6 z-50 border border-gray-100">
          ...
          <div className="space-y-4">
            <input
              className="w-full border border-gray-200 rounded-xl p-3 focus:ring-2 focus:ring-sky-400 outline-none"
              value={profile.name}

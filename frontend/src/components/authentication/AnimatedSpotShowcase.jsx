  ...
  return (
    <div className="hidden lg:flex w-1/2 relative items-center justify-center overflow-hidden h-screen bg-[#1a1c20]">
      ...
      <div className="relative z-10 text-center px-10 flex flex-col items-center">
        ...
        {/* SUST Spot Booking System - Larger and Whiter */}
        <p className="text-white/90 mb-10 text-[18px] md:text-[22px] font-black uppercase tracking-[0.4em] drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">
        ...
        <div className="relative inline-block">
          {/* Main Circular Image */}
          <div
            className="w-80 h-80 rounded-full border-[6px] border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.4)] transition-all duration-1000 ease-in-out"
            style={{
        ...
        {/* Field Name Section - Comparatively smaller but bold */}
        <div key={current} className="mt-12 animate-in fade-in zoom-in-95 duration-700">
          <h3 className="text-white/60 text-1xl md:text-2xl font-black tracking-widest uppercase drop-shadow-xl">
            {spots[current].name}
          </h3>
          <div className="h-1 w-12 bg-blue-500 mx-auto mt-4 rounded-full shadow-[0_0_15px_rgba(59,130,246,0.6)]" />
        </div>
      </div>
